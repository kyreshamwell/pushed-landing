...
export const features: Feature[] = [
  ...
  },
  {
    ...
    body: "Most reminder apps nag you on a timer. Pushed only speaks up when there is a reason: a midday heads-up if you have not pushed, an evening warning when a streak is genuinely on the line, and nothing at all on days you have already committed.",
  },
  {
